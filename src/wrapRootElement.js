...
const CONTENTFUL_SPACE = process.env.CONTENTFUL_SPACE // eslint-disable-line
const CONTENTFUL_ACCESS_TOKEN = process.env.CONTENTFUL_ACCESS_TOKEN // eslint-disable-line
const CONTENTFUL_ENV = process.env.CONTENTFUL_ENV // eslint-disable-line
